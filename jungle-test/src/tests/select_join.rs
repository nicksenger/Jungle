...
impl Action for CaptureJoinSumSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_6 = {
            state.joined_sum =
                output.map_err(|_err| Failure::from("join sum capture should succeed"))?;
        };
        Ok(__absorb_out_6)
    }
}
...
impl Action for SelectBranchWinnerFastSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_11 =
            output.map_err(|_err| Failure::from("select fast winner should succeed"))?;
        Ok(__absorb_out_11)
    }
}
...
impl Action for SelectBranchWinnerSlowSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_12 =
            output.map_err(|_err| Failure::from("select slow winner should succeed"))?;
        Ok(__absorb_out_12)
    }
}
...
impl Action for JoinBranchLeftValueSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_15 =
            output.map_err(|_err| Failure::from("join left value should succeed"))?;
        Ok(__absorb_out_15)
    }
}
...
impl Action for JoinBranchRightValueSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_16 =
            output.map_err(|_err| Failure::from("join right value should succeed"))?;
        Ok(__absorb_out_16)
    }
}
...
impl Action for ConditionalLeftPassthroughSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_17 =
            output.map_err(|_err| Failure::from("conditional left passthrough should succeed"))?;
        Ok(__absorb_out_17)
    }
}
...
impl Action for ConditionalRightPassthroughSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_18 =
            output.map_err(|_err| Failure::from("conditional right passthrough should succeed"))?;
        Ok(__absorb_out_18)
    }
}
...
impl Action for JoinFromConditionalLeftSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_19 =
            output.map_err(|_err| Failure::from("join from conditional left should succeed"))?;
        Ok(__absorb_out_19)
    }
}
...
impl Action for JoinFromConditionalRightSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_20 =
            output.map_err(|_err| Failure::from("join from conditional right should succeed"))?;
        Ok(__absorb_out_20)
    }
}
...
impl Action for JoinMutatesWinnerSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_21 = {
            let value =
                output.map_err(|_err| Failure::from("join mutates winner should succeed"))?;
            state.winner = value;
            value
        };
        Ok(__absorb_out_21)
...
impl Action for RightZeroValueSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_23 =
            output.map_err(|_err| Failure::from("right zero value should succeed"))?;
        Ok(__absorb_out_23)
    }
}
...
impl Action for RightNonZeroValueSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_24 =
            output.map_err(|_err| Failure::from("right non-zero value should succeed"))?;
        Ok(__absorb_out_24)
    }
}
...
impl Action for RightBranchMergeValueSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_25 =
            output.map_err(|_err| Failure::from("right branch merge value should succeed"))?;
        Ok(__absorb_out_25)
    }
}
...
impl Action for NestedJoinInnerLeftSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_32 = {
            let _ =
                output.map_err(|_err| Failure::from("nested join inner left should succeed"))?;
        };
        Ok(__absorb_out_32)
    }
}
...
impl Action for NestedJoinInnerRightSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_33 = {
            let _ =
                output.map_err(|_err| Failure::from("nested join inner right should succeed"))?;
        };
        Ok(__absorb_out_33)
    }
}
...
impl Action for NestedJoinOuterRightSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_35 = {
            let _ =
                output.map_err(|_err| Failure::from("nested join outer right should succeed"))?;
        };
        Ok(__absorb_out_35)
    }
}
...
impl Action for NestedJoinTailCaptureSpec {
    ...
    fn absorb(
        ...
        let __absorb_out_37 = {
            let value =
                output.map_err(|_err| Failure::from("nested join tail capture should succeed"))?;
...
async fn conditional_join_then_tail_streams_events_and_completes_with_local_client() {
    ...
    let journey_id = client
        .spawn::<LocalConditionalJoinTailAnimal>(&SelectJoinState::default())
        .await
