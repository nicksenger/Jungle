...
use jungle_sdk::types::{
    ...
    ManualExecutor, Running, Reflex, Waiting,
};
...
struct Seed;
impl Reflex<ProgressAnima> for Seed {
...
struct Finish;
impl Reflex<ProgressAnima> for Finish {
...
where
    Step: Reflex<ProgressAnima, Aspect = Identity, In = i32, Out = i32>,
