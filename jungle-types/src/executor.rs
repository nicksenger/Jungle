    ...
    In: DeserializeOwned + Serialize,
{
    fn request(
        ...
        let (choose_left, branch_input) = decode_controlled_input::<In, _>(&input, |carry| {
    ...
    In: DeserializeOwned + Serialize,
{
    fn request(
        ...
        let (should_continue, branch_input) = decode_controlled_input::<In, _>(&input, |carry| {
