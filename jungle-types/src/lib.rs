...
pub trait Animals {
    #[induce(
        base = meta::EmptyList,
        merge = meta::Merge<<Head as Animals>::List, <Tail as Animals>::List> where { (<Head as Animals>::List, <Tail as Animals>::List): meta::ListMappend },
        merge_variant = meta::Merge<<Head as Animals>::List, <Tail as Animals>::List> where { (<Head as Animals>::List, <Tail as Animals>::List): meta::ListMappend },
...
pub trait Actions {
    #[induce(
        base = meta::EmptyList,
        merge = meta::Merge<<Head as Actions>::List, <Tail as Actions>::List> where { (<Head as Actions>::List, <Tail as Actions>::List): meta::ListMappend },
        merge_variant = meta::Merge<<Head as Actions>::List, <Tail as Actions>::List> where { (<Head as Actions>::List, <Tail as Actions>::List): meta::ListMappend },
