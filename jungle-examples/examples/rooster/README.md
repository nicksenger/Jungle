...
```bash
RUST_LOG=warn,rooster=info,jungle_zoo::agent=debug cargo run --release --example rooster --features viewer -- spawn --roost-addr [::1]:4433 --openai-api-base-url http://localhost:8080 --circadian-interval 20s
```
