...
impl Act for PostMergeRest {
    type Effect = Rest<DRUMS_LANE_ID, 0>;
    type Input = ();
    type Output = ();
...
pub struct DrumPart01(
    Join<Step<Boot<36, 96, 192>>, Step<Hat<46, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<44, 96, 96>>,
    Step<Hat<44, 96, 96>>,
    ...
    Step<Hat<44, 96, 96>>,
    Step<Hat<44, 96, 96>>,
    Join<Step<Boot<36, 96, 96>>, Step<Hat<44, 96, 96>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<44, 96, 96>>,
    Step<Hat<44, 96, 96>>,
...
pub struct DrumPart03(
    ...
    Step<Hat<46, 96, 96>>,
    Step<Hat<46, 96, 96>>,
    Join<Step<Blast<57, 96, 96>>, Step<Boot<36, 96, 96>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<46, 96, 96>>,
    Step<Hat<46, 96, 96>>,
...
pub struct DrumPart04(
    ...
    Step<Hat<46, 96, 96>>,
    Step<Hat<46, 96, 96>>,
    Join<Step<Boot<36, 96, 96>>, Step<Hat<46, 96, 96>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<46, 96, 96>>,
    Step<Hat<46, 96, 96>>,
...
pub struct DrumPart05(
    ...
    Step<Hat<46, 192, 192>>,
    Step<Hat<46, 192, 192>>,
    Join<Step<Blast<57, 384, 384>>, Step<Boot<36, 384, 384>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<44, 384, 384>>,
    Join<Step<Blast<57, 384, 384>>, Step<Boot<36, 384, 384>>>,
...
pub struct DrumPart06(
    Step<Hat<44, 384, 384>>,
    Join<Step<Blast<57, 192, 192>>, Step<Snap<38, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Boot<35, 192, 192>>, Step<Snap<38, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Boot<35, 192, 192>>, Step<Snap<38, 192, 192>>>,
    Step<MergeUnit>,
...
pub struct DrumPart07(
    ...
    Join<Step<Blast<57, 192, 192>>, Step<Boot<36, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<46, 192, 192>>,
    Join<Step<Hat<46, 192, 192>>, Step<Snap<38, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<46, 192, 192>>,
    Join<Step<Boot<36, 192, 192>>, Step<Hat<46, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<46, 192, 192>>,
    Join<Step<Hat<46, 192, 192>>, Step<Snap<38, 192, 192>>>,
...
pub struct DrumPart09(
    ...
    Step<PostMergeRest>,
    Step<Hat<42, 192, 192>>,
    Join<Step<Hat<42, 192, 192>>, Step<Snap<38, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<42, 192, 192>>,
    Join<Step<Boot<36, 192, 192>>, Step<Hat<42, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<42, 192, 192>>,
    Join<Step<Hat<42, 192, 192>>, Step<Snap<38, 192, 192>>>,
...
pub struct DrumPart13(
    ...
    Join<Step<Blast<57, 192, 192>>, Step<BootDual<36, 36, 48, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<46, 192, 192>>,
    Join<Step<Hat<46, 192, 192>>, Step<Snap<38, 192, 192>>>,
...
pub struct DrumPart14(
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Blast<49, 192, 192>>, Step<Boot<36, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<46, 192, 192>>,
    Join<Step<Hat<46, 192, 192>>, Step<Snap<38, 192, 192>>>,
    ...
    Step<Snap<38, 48, 48>>,
    Step<Snap<38, 192, 96>>,
    Join<Step<Blast<57, 192, 384>>, Step<Boot<36, 192, 384>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<HatDual<44, 56, 192, 192, 384>>, Step<Snap<38, 192, 384>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    ...
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Boot<36, 192, 384>>, Step<HatDual<44, 56, 192, 192, 384>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
);
...
pub struct DrumPart15(
    ...
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Blast<57, 192, 288>>, Step<Boot<36, 192, 288>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Blast<49, 192, 288>>, Step<Boot<36, 192, 288>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Blast<57, 192, 384>>, Step<Boot<36, 192, 384>>>,
    Step<MergeUnit>,
...
pub struct DrumPart33(
    ...
    Step<Snap<38, 48, 48>>,
    Step<Snap<38, 192, 336>>,
    Join<Step<Blast<57, 384, 384>>, Step<BootDual<36, 36, 48, 384, 384>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Hat<51, 384, 384>>, Step<Snap<38, 384, 384>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<51, 192, 192>>,
    Step<Boot<36, 192, 192>>,
    ...
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Boot<36, 384, 384>>, Step<Hat<51, 384, 384>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Hat<51, 192, 192>>, Step<Snap<38, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Boot<36, 192, 192>>,
    Step<Hat<51, 192, 192>>,
...
pub struct DrumPart36(
    ...
    Step<Boot<36, 384, 384>>,
    Step<Snap<38, 48, 384>>,
    Join<Step<Boot<35, 192, 192>>, Step<SnapDual<38, 38, 48, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Boot<35, 192, 192>>, Step<Snap<38, 192, 192>>>,
    Step<MergeUnit>,
...
pub struct DrumPart39(
    ...
    Join<Step<Blast<57, 192, 192>>, Step<BootDual<36, 36, 96, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<51, 192, 192>>,
    Join<Step<Hat<51, 192, 192>>, Step<Snap<38, 192, 192>>>,
    ...
    Step<PostMergeRest>,
    Step<Hat<51, 192, 192>>,
    Join<Step<Boot<36, 192, 192>>, Step<Hat<51, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Boot<36, 192, 192>>, Step<Hat<51, 192, 192>>>,
    Step<MergeUnit>,
...
pub struct DrumPart42(
    ...
    Join<Step<BootDual<36, 36, 48, 192, 192>>, Step<Hat<51, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Boot<36, 192, 192>>, Step<Hat<51, 192, 192>>>,
    Step<MergeUnit>,
...
pub struct DrumPart48(
    ...
    Join<Step<BlastDual<49, 57, 192, 192, 384>>, Step<Boot<36, 192, 384>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Boot<36, 96, 288>>,
    ...
    Step<Boot<36, 96, 96>>,
    Step<TomHit<48, 96, 288>>,
    Join<Step<Boot<36, 96, 96>>, Step<Hat<56, 96, 96>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
);
...
pub struct DrumPart49(
    ...
    Step<Hat<56, 96, 96>>,
    Step<Hat<56, 96, 96>>,
    Join<Step<BlastDual<49, 57, 96, 96, 96>>, Step<Boot<36, 96, 96>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<44, 96, 96>>,
    Step<Hat<44, 96, 96>>,
    Step<Hat<44, 96, 96>>,
    Join<Step<HatBoot<44, 36, 96, 96, 96>>, Step<TomHit<43, 96, 96>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<44, 96, 96>>,
    Step<Hat<44, 96, 96>>,
    Join<Step<Hat<44, 96, 96>>, Step<TomTriad<48, 62, 62, 96, 96>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<HatBoot<44, 36, 96, 96, 96>>, Step<TomHit<43, 96, 96>>>,
    Step<MergeUnit>,
    ...
    Step<Hat<44, 96, 96>>,
    Step<Hat<44, 96, 96>>,
    Join<Step<HatBoot<44, 36, 96, 96, 96>>, Step<TomDual<43, 48, 96, 96, 96>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Hat<44, 96, 96>>,
    Step<Hat<44, 96, 96>>,
...
pub struct DrumPart50(
    Join<Step<Hat<44, 96, 96>>, Step<TomDual<62, 62, 96, 96, 96>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<HatBoot<44, 36, 96, 96, 96>>, Step<TomHit<43, 96, 96>>>,
    Step<MergeUnit>,
...
pub struct DrumPart60(
    ...
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Blast<49, 384, 384>>, Step<Boot<36, 384, 384>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Blast<57, 384, 384>>, Step<Boot<36, 384, 384>>>,
    Step<MergeUnit>,
...
pub struct DrumPart62(
    ...
    Step<HatDual<44, 56, 192, 192, 192>>,
    Step<Boot<36, 192, 192>>,
    Join<Step<HatDual<44, 56, 192, 192, 192>>, Step<Snap<38, 192, 192>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Step<Boot<36, 192, 192>>,
);
...
pub struct DrumPart67(
    ...
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Blast<49, 96, 288>>, Step<Boot<36, 96, 288>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Blast<57, 192, 288>>, Step<Boot<36, 192, 288>>>,
    Step<MergeUnit>,
...
pub struct DrumPart68(
    ...
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<Blast<57, 192, 576>>, Step<Boot<36, 192, 576>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
    Join<Step<BlastDual<49, 57, 384, 384, 384>>, Step<Boot<36, 384, 384>>>,
    Step<MergeUnit>,
    Step<PostMergeRest>,
);
