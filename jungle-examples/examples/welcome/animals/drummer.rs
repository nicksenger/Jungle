...
pub struct Hat46SnapCadence(
    jungle_zoo::ClonedJoinUnit<Step<Hat<46, 192, 0>>, Step<Snap<38, 192, 0>>>,
    Step<MergeUnit>,
...
pub struct BootHat46Cadence(
    jungle_zoo::ClonedJoinUnit<Step<Boot<36, 192, 0>>, Step<Hat<46, 192, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
);
...
pub struct Hat42SnapCadence(
    jungle_zoo::ClonedJoinUnit<Step<Hat<42, 192, 0>>, Step<Snap<38, 192, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
);
...
pub struct BootHat42Cadence(
    jungle_zoo::ClonedJoinUnit<Step<Boot<36, 192, 0>>, Step<Hat<42, 192, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
);
...
>(
    jungle_zoo::ClonedJoinUnit<
        Step<Hat<NOTE_1, NOTE_TICK_1, 0>>,
        Step<Hat<NOTE_2, NOTE_TICK_2, 0>>,
    >,
    Step<MergeUnit>,
...
>(
    jungle_zoo::ClonedJoinUnit<
        Step<Boot<NOTE_1, NOTE_TICK_1, 0>>,
        Step<Boot<NOTE_2, NOTE_TICK_2, 0>>,
    >,
    Step<MergeUnit>,
    Step<PostMergeRest<REST_TICK>>,
);
...
>(
    jungle_zoo::ClonedJoinUnit<
        Step<Snap<NOTE_1, NOTE_TICK_1, 0>>,
        Step<Snap<NOTE_2, NOTE_TICK_2, 0>>,
    >,
    Step<MergeUnit>,
    Step<PostMergeRest<REST_TICK>>,
);
...
>(
    jungle_zoo::ClonedJoinUnit<
        Step<Blast<NOTE_1, NOTE_TICK_1, 0>>,
        Step<Blast<NOTE_2, NOTE_TICK_2, 0>>,
    >,
    Step<MergeUnit>,
    Step<PostMergeRest<REST_TICK>>,
);
...
>(
    jungle_zoo::ClonedJoinUnit<
        Step<TomHit<NOTE_1, NOTE_TICK_1, 0>>,
        Step<TomHit<NOTE_2, NOTE_TICK_2, 0>>,
    >,
    Step<MergeUnit>,
    Step<PostMergeRest<REST_TICK>>,
);
...
pub struct TomTriadPair<const NOTE_1: u8, const NOTE_2: u8, const NOTE_TICK: u32>(
    jungle_zoo::ClonedJoinUnit<
        Step<TomHit<NOTE_1, NOTE_TICK, 0>>,
        Step<TomHit<NOTE_2, NOTE_TICK, 0>>,
    >,
    Step<MergeUnit>,
);
...
>(
    jungle_zoo::ClonedJoinUnit<
        TomTriadPair<NOTE_1, NOTE_2, NOTE_TICK>,
        Step<TomHit<NOTE_3, NOTE_TICK, 0>>,
    >,
    Step<MergeUnit>,
    Step<PostMergeRest<REST_TICK>>,
);
...
pub struct DrumPart01(
    jungle_zoo::ClonedJoinUnit<Step<Boot<36, 96, 0>>, Step<Hat<46, 192, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    DrumHat44Fourteen,
    jungle_zoo::ClonedJoinUnit<Step<Boot<36, 96, 0>>, Step<Hat<44, 96, 0>>>,
    Step<MergeUnit>,
...
pub struct DrumPart03(
    ...
    Step<Hat<46, 96, 96>>,
    Step<Hat<46, 96, 96>>,
    jungle_zoo::ClonedJoinUnit<Step<Blast<57, 96, 0>>, Step<Boot<36, 96, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<96>>,
    Step<Hat<46, 96, 96>>,
    Step<Hat<46, 96, 96>>,
...
pub struct DrumPart04(
    DrumHat46Eleven,
    jungle_zoo::ClonedJoinUnit<Step<Boot<36, 96, 0>>, Step<Hat<46, 96, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<96>>,
    DrumHat46Eleven,
);
...
pub struct DrumPart05(
    ...
    Step<Hat<46, 192, 192>>,
    Step<Hat<46, 192, 192>>,
    jungle_zoo::ClonedJoinUnit<Step<Blast<57, 384, 0>>, Step<Boot<36, 384, 0>>>,
    Step<MergeUnit>,
...
pub struct DrumPart06(
    Step<Hat<44, 384, 384>>,
    jungle_zoo::ClonedJoinUnit<Step<Blast<57, 192, 0>>, Step<Snap<38, 192, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    jungle_zoo::ClonedJoinUnit<Step<Boot<35, 192, 0>>, Step<Snap<38, 192, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    jungle_zoo::ClonedJoinUnit<Step<Boot<35, 192, 0>>, Step<Snap<38, 192, 0>>>,
    Step<MergeUnit>,
...
pub struct DrumPart07(
    ...
    jungle_zoo::ClonedJoinUnit<Step<Blast<57, 192, 0>>, Step<Boot<36, 192, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    Step<Hat<46, 192, 192>>,
    Hat46SnapCadence,
...
pub struct DrumPart13(
    ...
    jungle_zoo::ClonedJoinUnit<Step<Blast<57, 192, 0>>, BootDual<36, 36, 48, 192, 0>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    Step<Hat<46, 192, 192>>,
    Hat46SnapCadence,
...
pub struct DrumPart14(
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    jungle_zoo::ClonedJoinUnit<Step<Blast<49, 192, 0>>, Step<Boot<36, 192, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    Step<Hat<46, 192, 192>>,
    Hat46SnapCadence,
    ...
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<HatDual<44, 56, 192, 192, 0>, Step<Snap<38, 192, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    ...
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<Boot<36, 192, 0>>, HatDual<44, 56, 192, 192, 0>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
);
...
pub struct DrumPart33(
    ...
    Step<Snap<38, 48, 48>>,
    Step<Snap<38, 192, 336>>,
    jungle_zoo::ClonedJoinUnit<Step<Blast<57, 384, 0>>, BootDual<36, 36, 48, 384, 0>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<Hat<51, 384, 0>>, Step<Snap<38, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    Step<Hat<51, 192, 192>>,
    Step<Boot<36, 192, 192>>,
    ...
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<Boot<36, 384, 0>>, Step<Hat<51, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<Hat<51, 192, 0>>, Step<Snap<38, 192, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    Step<Boot<36, 192, 192>>,
    Step<Hat<51, 192, 192>>,
...
pub struct DrumPart36(
    ...
    Step<Boot<36, 384, 384>>,
    Step<Snap<38, 48, 384>>,
    jungle_zoo::ClonedJoinUnit<Step<Boot<35, 192, 0>>, SnapDual<38, 38, 48, 192, 0>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    jungle_zoo::ClonedJoinUnit<Step<Boot<35, 192, 0>>, Step<Snap<38, 192, 0>>>,
    Step<MergeUnit>,
...
pub struct DrumPart39(
    ...
    jungle_zoo::ClonedJoinUnit<Step<Blast<57, 192, 0>>, BootDual<36, 36, 96, 192, 0>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    Step<Hat<51, 192, 192>>,
    jungle_zoo::ClonedJoinUnit<Step<Hat<51, 192, 0>>, Step<Snap<38, 192, 0>>>,
    ...
    Step<PostMergeRest<192>>,
    Step<Hat<51, 192, 192>>,
    jungle_zoo::ClonedJoinUnit<Step<Boot<36, 192, 0>>, Step<Hat<51, 192, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    jungle_zoo::ClonedJoinUnit<Step<Boot<36, 192, 0>>, Step<Hat<51, 192, 0>>>,
    Step<MergeUnit>,
...
pub struct DrumPart42(
    ...
    jungle_zoo::ClonedJoinUnit<BootDual<36, 36, 48, 192, 0>, Step<Hat<51, 192, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    jungle_zoo::ClonedJoinUnit<Step<Boot<36, 192, 0>>, Step<Hat<51, 192, 0>>>,
    Step<MergeUnit>,
...
pub struct DrumPart48(
    ...
    jungle_zoo::ClonedJoinUnit<BlastDual<49, 57, 192, 192, 0>, Step<Boot<36, 192, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    Step<Boot<36, 96, 288>>,
    ...
    Step<Boot<36, 96, 96>>,
    Step<TomHit<48, 96, 288>>,
    jungle_zoo::ClonedJoinUnit<Step<Boot<36, 96, 0>>, Step<Hat<56, 96, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<96>>,
);
...
pub struct DrumPart49(
    ...
    Step<Hat<56, 96, 96>>,
    Step<Hat<56, 96, 96>>,
    jungle_zoo::ClonedJoinUnit<BlastDual<49, 57, 96, 96, 0>, Step<Boot<36, 96, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<96>>,
    Step<Hat<44, 96, 96>>,
    Step<Hat<44, 96, 96>>,
    Step<Hat<44, 96, 96>>,
    jungle_zoo::ClonedJoinUnit<HatBoot<44, 36, 96, 96, 0>, Step<TomHit<43, 96, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<96>>,
    Step<Hat<44, 96, 96>>,
    Step<Hat<44, 96, 96>>,
    jungle_zoo::ClonedJoinUnit<Step<Hat<44, 96, 0>>, TomTriad<48, 62, 62, 96, 0>>,
    Step<MergeUnit>,
    Step<PostMergeRest<96>>,
    jungle_zoo::ClonedJoinUnit<HatBoot<44, 36, 96, 96, 0>, Step<TomHit<43, 96, 0>>>,
    Step<MergeUnit>,
    ...
    Step<Hat<44, 96, 96>>,
    Step<Hat<44, 96, 96>>,
    jungle_zoo::ClonedJoinUnit<HatBoot<44, 36, 96, 96, 0>, TomDual<43, 48, 96, 96, 0>>,
    Step<MergeUnit>,
    Step<PostMergeRest<96>>,
    Step<Hat<44, 96, 96>>,
    Step<Hat<44, 96, 96>>,
...
pub struct DrumPart50(
    jungle_zoo::ClonedJoinUnit<Step<Hat<44, 96, 0>>, TomDual<62, 62, 96, 96, 0>>,
    Step<MergeUnit>,
    Step<PostMergeRest<96>>,
    jungle_zoo::ClonedJoinUnit<HatBoot<44, 36, 96, 96, 0>, Step<TomHit<43, 96, 0>>>,
    Step<MergeUnit>,
...
pub struct DrumPart60(
    ...
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<Blast<49, 384, 0>>, Step<Boot<36, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<Blast<57, 384, 0>>, Step<Boot<36, 384, 0>>>,
    Step<MergeUnit>,
...
pub struct DrumPart67(
    ...
    Step<MergeUnit>,
    Step<PostMergeRest<288>>,
    jungle_zoo::ClonedJoinUnit<Step<Blast<49, 96, 0>>, Step<Boot<36, 96, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<288>>,
    jungle_zoo::ClonedJoinUnit<Step<Blast<57, 192, 0>>, Step<Boot<36, 192, 0>>>,
    Step<MergeUnit>,
...
pub struct DrumPart68(
    ...
    jungle_zoo::ClonedJoinUnit<BlastDual<49, 57, 384, 384, 0>, Step<Boot<36, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
);
...
pub struct ConditionalJoinSound100LeftArm(
    jungle_zoo::ClonedJoinUnit<Step<Hat<46, 100, 0>>, Step<Hat<42, 100, 0>>>,
    Step<MergeUnit>,
...
pub struct ConditionalJoinSound100RightArm(
    jungle_zoo::ClonedJoinUnit<Step<Boot<36, 100, 0>>, Step<Hat<44, 100, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<0>>,
);
