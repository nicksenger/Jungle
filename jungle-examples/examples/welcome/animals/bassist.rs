...
pub struct BassPart08Phrase(
    ...
    Step<Thump<39, 192, 192>>,
    Step<Thump<32, 192, 192>>,
    jungle_zoo::ClonedJoinUnit<Step<Thump<35, 384, 0>>, Step<HarmonySing<71, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<Thump<35, 384, 0>>, Step<HarmonySing<70, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<Thump<35, 192, 0>>, Step<HarmonySing<68, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    Step<Thump<27, 192, 192>>,
    jungle_zoo::ClonedJoinUnit<Step<Thump<30, 192, 0>>, Step<HarmonySing<66, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    Step<Thump<27, 192, 192>>,
    jungle_zoo::ClonedJoinUnit<Step<Thump<37, 384, 0>>, Step<HarmonySing<73, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
);
...
pub struct BassPart09Phrase(
    jungle_zoo::ClonedJoinUnit<Step<Thump<37, 384, 0>>, Step<HarmonySing<72, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<Thump<37, 384, 0>>, Step<HarmonySing<70, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<Thump<37, 192, 0>>, Step<HarmonySing<68, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<192>>,
    Step<Thump<32, 96, 96>>,
    Step<Thump<38, 96, 96>>,
...
pub struct BassJoinSound100JoinAndRest(
    jungle_zoo::ClonedJoinUnit<Step<Thump<35, 100, 0>>, Step<HarmonySing<71, 100, 0>>>,
    Step<MergeUnit>,
);
...
mod tests {
    ...
    async fn join_Sound_100_ticks_zero_rest_with_tail_streams_events_and_completes_with_local_client(
        ...
        for index in 0..PARALLEL_JOURNEYS {
            let journey_id = client
                .spawn::<BassJoinSound100Animal>(&seed)
                .await
