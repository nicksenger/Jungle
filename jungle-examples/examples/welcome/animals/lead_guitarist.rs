...
pub struct JoinPluck<const NOTE_1: u8, const NOTE_2: u8, const NOTE_TICK: u32, const REST_TICK: u32>(
    jungle_zoo::ClonedJoinUnit<
        Step<JoinPick<NOTE_1, NOTE_TICK, 0>>,
        Step<JoinPick<NOTE_2, NOTE_TICK, 0>>,
    >,
    Step<MergeUnit>,
...
>(
    jungle_zoo::ClonedJoinUnit<
        JoinPluck<NOTE_1, NOTE_2, NOTE_TICK, 0>,
        JoinPluck<NOTE_3, NOTE_4, NOTE_TICK, 0>,
    >,
    Step<MergeUnit>,
    Step<PostMergeRest<REST_TICK>>,
);
...
>(
    jungle_zoo::ClonedJoinUnit<
        Step<JoinPick<NOTE_1, NOTE_TICK_1, 0>>,
        Step<JoinPick<NOTE_2, NOTE_TICK_2, 0>>,
    >,
    Step<MergeUnit>,
    Step<PostMergeRest<REST_TICK>>,
);
...
pub struct LeadPart13(
    ...
    Step<Pick<48, 192, 192>>,
    Step<Pick<46, 192, 192>>,
    jungle_zoo::ClonedJoinUnit<JoinPluck<54, 47, 384, 0>, Step<HarmonySing<71, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<JoinPick<46, 384, 0>>, Step<HarmonySing<70, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<JoinPick<44, 384, 0>>, Step<HarmonySing<68, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<JoinPick<42, 384, 0>>, Step<HarmonySing<66, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<JoinPluck<56, 49, 384, 0>, Step<HarmonySing<73, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<JoinPick<48, 384, 0>>, Step<HarmonySing<72, 384, 0>>>,
    Step<MergeUnit>,
    Step<PostMergeRest<384>>,
    jungle_zoo::ClonedJoinUnit<Step<JoinPick<46, 384, 0>>, Step<HarmonySing<70, 384, 0>>>,
    Step<MergeUnit>,
...
pub struct LeadJoinSound100JoinAndRest(
    jungle_zoo::ClonedJoinUnit<JoinPluck<54, 47, 100, 0>, Step<HarmonySing<71, 100, 0>>>,
    Step<MergeUnit>,
);
