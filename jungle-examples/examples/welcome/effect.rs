...
#[effect(id = 517)]
impl<const LANE_ID: u32, const NOTE_TICK: u32, const REST_TICK: u32>
    jungle_sdk::prelude::Effect<TheJungle> for SyncedRest<LANE_ID, NOTE_TICK, REST_TICK>
{
    type In = ();
    type Out = ();
    type Err = String;
