...
fn main() -> Result<(), String> {
    ...
    println!(
        "// Generated by welcome_score_grid ({:.3} BPM, {}/{})",
...
fn emit_score_literals(score: &ScoreFile, config: &Config) -> Result<(), String> {
    ...
    println!();
    println!("// score={} source_bpm={source_bpm:.3}", score.name);
    ...
    for event in iter {
        ...
        println!(
            "GridNote {{ score: \"{}\", midi: {}, start_tick: {}, duration_tick: {}, kind: {}, beats: {}, seconds: {}, position: Position {{ bar: {}, beat: {}, beat_offset_num: {}, beat_offset_den: {} }} }},",
            score.name,
            note.midi,
            note.start_tick,
            note.duration_tick,
